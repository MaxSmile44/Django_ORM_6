...
def index(request):
    ...
    most_popular_posts = post.popular().author_and_tags_count()[:5]
    most_popular_posts = post.fetch_with_comments_count(posts=most_popular_posts)

    fresh_posts = (post.fetch_with_comments_count().
